...
export const SEASONAL_PERIODS_2026 = {
  A: {
    ...
    tourismTaxRate: 1.1, // €1.10 for months 1,2,3,10,11,12
  },
  B: {
    ...
    tourismTaxRate: 1.1, // €1.10 for months transitioning
  },
  C: {
    ...
    tourismTaxRate: 1.6, // €1.60 for summer months
  },
  D: {
    name: 'Peak Summer',
    periods: [
    ...
    tourismTaxRate: 1.6, // €1.60 for peak summer
  },
};
...
export const AGENCY_PRICING_TEMPLATES: PricingData2026[] = [
  {
    ...
    seasonalRates: {
      ...
      B: 0.9, // 10% discount
      C: 0.95, // 5% discount
      D: 0.9, // 10% discount in peak season
    },
    isDefault: false,
    validFrom: new Date('2026-01-01'),
    validTo: new Date('2026-12-31'),
...
export const PRICING_RULES_2026 = {
  ...
  tourismTax: {
    lowSeason: 1.1, // €1.10 for months 1,2,3,10,11,12
    highSeason: 1.6, // €1.60 for months 4,5,6,7,8,9
    childrenDiscount: {
  ...
  shortStayRule: {
    minimumNights: 3,
    supplement: 0.2, // +20% on accommodation price only
  ...
  // Additional Services
  additionalServices: {
    parking: 7.0, // €7 per night
    pets: 20.0, // €20 per stay
    towelRental: 5.0, // €5 per day (example rate)
  },
