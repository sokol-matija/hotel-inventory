...
export default function GuestsPageV2() {
  const {
    state,
    searchGuests,
    selectGuest,
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Guest Management V2</h1>
            <p className="text-gray-600">Clean, modern guest management with Supabase integration</p>
          </div>
