...
erDiagram
    ...
    RESERVATIONS }o--o| COMPANIES : for_company
    RESERVATIONS }o--o| PRICING_TIERS : uses_tier

    %% Financial
    INVOICES ||--o| FISCAL_RECORDS : fiscalized_by
    INVOICES ||--o{ PAYMENTS : paid_by
    INVOICES }o--o| GUESTS : billed_to
    INVOICES }o--o| COMPANIES : billed_to
